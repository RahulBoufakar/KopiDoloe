        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('stoks.store')}}" class="form" method="POST" onsubmit="return stripFormatting(this)">
                            @csrf
                            @method('POST')
                            <div class="form-item">
                            ...
                            <div class="form-item">
                                ...
                                <input type="number" name="harga" id="numberInput" class="form-control" required oninput="formatCurrency(this)"> 
                            </div>
                            <div class="form-item">
